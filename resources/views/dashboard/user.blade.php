        ...
        <div class="container">
            ...
            <div class="card-grid">
                ...
                <div class="card">
                    ...
                    <p class="card-text">مشاهده تاریخچه پرداخت‌های موفق</p>
                    <a href="{{ route('successful_payments.index') }}" class="card-btn">مشاهده</a>
                </div>
                <div class="card">
                    <h5 class="card-title">بسته‌های خریداری‌شده</h5>
                    <p class="card-text">مشاهده بسته‌های خریداری‌شده</p>
                    <a href="{{ route('purchased_packages.index') }}" class="card-btn">مشاهده</a>
                </div>
                <div class="card">
                    <h5 class="card-title">تراکنش‌ها</h5>
                    <p class="card-text">مشاهده تغییرات شارژ حساب</p>
                    <a href="{{ route('transactions.index') }}" class="card-btn">مشاهده</a>
                </div>
                <div class="card">
